...
```bash
git worktree add ../my-project--prompt-manager -b feature/prompt-manager
```
...
├── my-project--prompt-manager/      # Worktree for feature
└── my-project--other-feature/       # Another worktree
```
