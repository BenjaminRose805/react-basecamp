 ...
 *
 * Usage:
 *   node .claude/scripts/setup-package-manager.js [pm-name]
 *   node .claude/scripts/setup-package-manager.js --detect
 *   node .claude/scripts/setup-package-manager.js --global pnpm
...
Usage:
  node .claude/scripts/setup-package-manager.js [options] [package-manager]
...
Examples:
  ...
  node .claude/scripts/setup-package-manager.js --list
`);
}
